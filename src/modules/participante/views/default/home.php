    ...
    <div class="row mt-3 mb-3">
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?php if (($regulamentos[0] ?? null) !== null): ?>
                        <a class="btn btn-md btn-success m-1"
                            href="/pdf/<?= $regulamentos[0]->arquivo ?>"
                            target="_blank">
                            Para ver o regulamento do interior versão.
                        </a>
                    <?php endif; ?>

                    <?php if (($regulamentos[1] ?? null) !== null): ?>
                        <a class="btn btn-md btn-success m-1"
                            href="/pdf/<?= $regulamentos[1]->arquivo ?>"
                            target="_blank">
        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php if (isset($informativos[0])): ?>
                        <a class="btn btn-md btn-success"
                            href="/pdf/<?= $informativos[0]->arquivo ?>"
                            target="_blank">
                            Clique para acessar a relação de hemocentros
                        </a>
                    <?php endif; ?>

                    <?php if (isset($informativos[1])): ?>
                        <a class="btn btn-md btn-success"
                            href="/pdf/<?= $informativos[1]->arquivo ?>"
                            target="_blank">
