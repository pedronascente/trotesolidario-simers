...
<style type="text/css">
    .tg {}
    .tg td { font-family: Arial, sans-serif; font-size: 14px; overflow: hidden;padding: 10px 15px;word-break: normal;}
...
<body class="body">
    <div
        style="background-color: #520EBA; background-repeat: no-repeat; background-size: cover;background-image: url('<?= $bGcertificado20252Resized?>'); ">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="tg-baqh" colspan="3">
                                <img src="<?= $logoSite2025 ?>" style="width:auto;height: 130px;" alt="logo" />
                            </th>
                            <th class="tg-0lax"></th>
                        </tr>
                    </thead>
